...
namespace MVC_Reg_UserExample.Models
{
    public class DBHandler
    {
        ...
        public List<UserClass> GetItemList()
        {
            ...
            string query1 = "select UserName, Email_id, Password, Gender from MyMvc2";
        ...
        {
            Connection();
            string query="update MyMvc2 set Email_id='"+uc2.Email_id+"',Password='"+uc2.Password+"',Gender='"+uc2.Gender+"' where UserName='"+uc2.UserName+"'";
        ...
        {
            Connection();
            string query3 = "delete from MyMvc2 where UserName='"+UserName+"'";
